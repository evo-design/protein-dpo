...
import torch
import pandas as pd
from esm.inverse_folding.util import score_sequence, get_sequence_loss
import numpy as np
import argparse
import os
...
parser.add_argument('--feature', type=str, default='ddG_ML', required = False, help='name of fitness value')
...
parser.add_argument('--pdb_dir', type=str, default='data/af_pdbs/', required = False, help='directory containing pdbs')
...
for pdb_path, group_df in (pdb_grouped, total = len(pdb_grouped)):
